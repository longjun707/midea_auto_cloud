...
class MideaWaterHeaterEntityEntity(MideaEntity, WaterHeaterEntity):
    ...
    def min_temp(self):
        if isinstance(self._key_min_temp, str):
            ...
            return float(val) if val is not None else 35.0
        else:
            return float(self._key_min_temp) if self._key_min_temp is not None else 35.0
    ...
    def max_temp(self):
        if isinstance(self._key_max_temp, str):
            ...
            return float(self._key_max_temp) if self._key_max_temp is not None else 65.0
